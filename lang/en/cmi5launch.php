...
$string['admindashboard:viewadmindashboard'] = 'View admin dashboard';
...
$string['reinitializing'] = 'Reinitializing your course registration...';
...
$string['reset'] = 'Reset';
$string['engagementmetrics'] = 'Engagement Metrics';
$string['totalsessions'] = 'Total Sessions';
$string['activesessions'] = 'Active Sessions';
$string['activeusers'] = 'Active Users';
$string['activitybreakdown'] = 'Activity Breakdown';
$string['started'] = 'Started';
$string['completionrate'] = 'Completion Rate';
$string['generateinsights'] = 'Generate Insights';
$string['insighttype'] = 'Insight Type';
$string['progressanalysis'] = 'Overall Progress Analysis';
$string['engagementpatterns'] = 'User Engagement Patterns';
$string['learningrecommendations'] = 'Learning Recommendations';
$string['atriskusers'] = 'At-Risk Users';
$string['aiprovider'] = 'AI Provider';
$string['aiprovider_help'] = 'Select an AI provider for generating insights (OpenAI, Claude, or local LLM)';
